...
export const siteName = 'ZooBOTix';
export const siteDescription = 'The Official Website of Team 6002 ZooBOTix';
...
export const blog = {
  // RSS feed
  name: 'Team ZooBOTix Blog',
  description: 'All about Team 6002 ZooBOTix and our journey through the FIRST Robotics Competition (FRC).',
